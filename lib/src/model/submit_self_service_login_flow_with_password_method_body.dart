    ...
    Iterable<Object?> serialize(Serializers serializers, SubmitSelfServiceLoginFlowWithPasswordMethodBody object,
        ...
        result
            ...
            ..add(serializers.serialize(object.method,
                specifiedType: const FullType(SubmitSelfServiceLoginFlowWithPasswordMethodBodyMethodEnum)));
        result
            ..add(r'password')
            ...
            switch (key) {
                ...
                case r'method':
                    result.method = serializers.deserialize(value,
                        specifiedType: const FullType(SubmitSelfServiceLoginFlowWithPasswordMethodBodyMethodEnum)) as SubmitSelfServiceLoginFlowWithPasswordMethodBodyMethodEnum;
                    break;
                case r'password':
...
class SubmitSelfServiceLoginFlowWithPasswordMethodBodyMethodEnum extends EnumClass {

  /// Method should be set to \"password\" when logging in using the identifier and password strategy.
  @BuiltValueEnumConst(wireName: r'password')
  static const SubmitSelfServiceLoginFlowWithPasswordMethodBodyMethodEnum password = _$submitSelfServiceLoginFlowWithPasswordMethodBodyMethodEnum_password;
  /// Method should be set to \"password\" when logging in using the identifier and password strategy.
  @BuiltValueEnumConst(wireName: r'oidc')
  static const SubmitSelfServiceLoginFlowWithPasswordMethodBodyMethodEnum oidc = _$submitSelfServiceLoginFlowWithPasswordMethodBodyMethodEnum_oidc;

  static Serializer<SubmitSelfServiceLoginFlowWithPasswordMethodBodyMethodEnum> get serializer => _$submitSelfServiceLoginFlowWithPasswordMethodBodyMethodEnumSerializer;

  const SubmitSelfServiceLoginFlowWithPasswordMethodBodyMethodEnum._(String name): super(name);

  static BuiltSet<SubmitSelfServiceLoginFlowWithPasswordMethodBodyMethodEnum> get values => _$submitSelfServiceLoginFlowWithPasswordMethodBodyMethodEnumValues;
  static SubmitSelfServiceLoginFlowWithPasswordMethodBodyMethodEnum valueOf(String name) => _$submitSelfServiceLoginFlowWithPasswordMethodBodyMethodEnumValueOf(name);
}
